...
public class GenreConfig {
	 ...
	 */
	@Bean
	public GeminiClient geminiClient(GeminiProperties properties, MeterRegistry meterRegistry,
			ObservationRegistry observationRegistry) {
		if (!properties.isConfigured()) {
			return new GeminiClient(null, properties, meterRegistry);
		}
		...
		ChatModel chatModel = GoogleGenAiChatModel.builder()
				...
				.observationRegistry(observationRegistry)
				.build();
		return new GeminiClient(ChatClient.create(chatModel, observationRegistry), properties, meterRegistry);
	}
