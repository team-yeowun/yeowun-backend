...
class CultureResponseBindingTest {
    ...
    void 성공응답_파싱() throws Exception {
        String body = "<response><header><resultCode>00</resultCode><resultMsg>정상입니다.</resultMsg></header>"
            ...
            + "</items></body></response>";
        KoreaCultureDto.Realm2ListResponse res = xml.readValue(body, KoreaCultureDto.Realm2ListResponse.class);
    ...
    void 에러응답_isSuccess_false() throws Exception {
        ...
        assertThat(xml.readValue(body, KoreaCultureDto.Realm2ListResponse.class).isSuccess()).isFalse();
    }
}
